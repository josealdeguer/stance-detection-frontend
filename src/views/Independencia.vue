<template>
  <div class="container independencia">
...
.independencia {
  margin-top: 50px;
  max-width: 1200px;
  background: linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url("https://espacio-publico.com/wp-content/uploads/2019/02/desobediencia-catalu%C3%B1a-2.jpg");
}
</style>
